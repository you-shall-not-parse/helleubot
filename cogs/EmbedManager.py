    ...
    def get_embed_blocks(self):
        ...
        embed2.add_field(
            ...
            value=(
                ...
                "- An artillery glitch can happen whereby rounds won't fire, operators can leave the gun provided that a clip post-match is submitted showing the gun not loading 2/3 times.\n"
            ),
            inline=False,
        )
        embed2.add_field(
            name=":boom: Outfield Artillery",
            value=(
